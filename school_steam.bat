...
echo if exist "%program1%" set "options=%options%1. Option 1" ^& set "program[1]=%program1%" >> launcher.bat
echo if exist "%program2%" set "options=%options%2. Option 2" ^& set "program[2]=%program2%" >> launcher.bat
echo if exist "%program3%" set "options=%options%3. Option 3" ^& set "program[3]=%program3%" >> launcher.bat
echo if exist "%program4%" set "options=%options%4. Option 4" ^& set "program[4]=%program4%" >> launcher.bat
echo if exist "%program5%" set "options=%options%5. Option 5" ^& set "program[5]=%program5%" >> launcher.bat
echo if exist "%program6%" set "options=%options%6. Option 6" ^& set "program[6]=%program6%" >> launcher.bat
echo if exist "%program7%" set "options=%options%7. Option 7" ^& set "program[7]=%program7%" >> launcher.bat
echo echo Displaying available options... >> launcher.bat
echo echo Choose an option: >> launcher.bat
echo echo %options% >> launcher.bat
